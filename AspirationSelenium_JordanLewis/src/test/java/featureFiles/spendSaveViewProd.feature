Feature: Verify that user can view products and prices 

Scenario: User should be able to view products and prices via Spend & Save link (Aspiration and Aspiration Plus)
